...
def build_lca_distance(hierarchy: dict):
    n = len(hierarchy)
...
if __name__ == "__main__":
    ...
    if dist_file.exists():
        print(f"Distance matrix file {dist_file} already exists. Skipping distance matrix computation.")
    else:
        print(f"Building distance matrix for {filename}...")
        dist_matrix = build_lca_distance(hierarchy)
